...
public class ShiftService {
    ...
    public ShiftDto createShift(Integer activityId, ShiftDto shiftDto) {
        if (shiftDto == null) throw new HEException(SHIFT_REQUIRES_INFORMATION);
        ...
        if (activity.getState() != Activity.State.APPROVED) throw new HEException(SHIFT_ACTIVITY_NOT_APPROVED);
